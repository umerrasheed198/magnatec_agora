...
import 'package:magnatec_voip_app/pages/call.dart';
...
class _IndexPageState extends State<IndexPage> {
  ...
  Future<void> onJoin() async {
    ...
    if(_channelController.text.isNotEmpty){
      ...
      await Navigator.push(context, MaterialPageRoute(builder: (context) => CallPage(channelName: _channelController.text)));
